    ...
    <main className="min-h-screen bg-[#FDFAF6] flex flex-col">
      ...
      <nav className="border-b border-black/[0.07] bg-white/80 backdrop-blur sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/register" className="flex items-center justify-center gap-2 px-4 py-1.5 rounded-xl font-semibold text-xs bg-gradient-to-br from-[#FF8A73] to-[#9B84F7] text-white shadow-lg hover:opacity-90 transition-all">Get Started Free →</Link>
          </div>
        </div>
      </nav>
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-[#1A1410] mb-6 max-w-3xl leading-tight" style={{ fontFamily: "'Fraunces', serif" }}>
          Your tasks,<br />
          <span className="bg-gradient-to-r from-[#FF8A73] to-[#9B84F7] bg-clip-text text-transparent">beautifully organized</span>
        </h1>
        ...
        <div className="flex items-center gap-4 flex-wrap justify-center">
          <Link href="/register" className="flex items-center justify-center px-8 py-3 rounded-xl font-semibold text-base bg-gradient-to-br from-[#FF8A73] to-[#9B84F7] text-white shadow-lg hover:opacity-90 transition-all">
            Start for free
          </Link>
          <Link href="/login" className="flex items-center justify-center px-8 py-3 rounded-xl font-medium text-base border border-black/10 bg-white text-[#6B6259] hover:bg-black/[0.03] transition-all">
            Sign in
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {features.map((f, i) => (
          <div key={i} className="bg-white rounded-2xl border border-black/[0.07] shadow-sm p-6">
